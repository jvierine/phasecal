...
$Id: regression_test_digital_rf_hdf5.py 411 2014-05-23 20:37:12Z brideout $
"""
...
read_result = testReadObj.read_vector(cont_data_arr[0][0], cont_data_arr[0][1], chan_name)
...
try:
    # read too far
    result = testReadObj.read_vector(cont_data_arr[0][0], cont_data_arr[0][1]+1, chan_name)
...
read_result = testReadObj.read_vector(cont_data_arr[0][0], long(cont_data_arr[0][1]-1), chan_name)
...
t = time.time()
result = testReadObj.read_vector(start_index, end_index-start_index, chan_name)
