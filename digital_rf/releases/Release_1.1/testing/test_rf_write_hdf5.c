 ...
 *
 * $Id: test_rf_write_hdf5.c 417 2014-05-27 14:17:24Z brideout $
 */
...
int main (int argc, char *argv[])
{
	...
	data_object = digital_rf_create_write_hdf5("/tmp/hdf5/junk0", H5T_NATIVE_INT, 40, 10, global_index, sample_rate, "FAKE_UUID_0", 0, 0, 1, 1, 0);
	if (!data_object)
		exit(-1);
	for (i=0; i<7; i++)
	{
