...
int main (int argc, char *argv[])
{
  ...
  data_object = digital_rf_create_write_hdf5("/tmp/hdf5/junk0", H5T_NATIVE_SHORT, WRITE_BLOCK_SIZE, 10, global_start_sample, SAMPLE_RATE, "FAKE_UUID_0", 0, 0, 1, NUM_SUBCHANNELS, 1);
  begin = clock();
  ...
  printf("Start writing\n");
  vector_leading_edge_index=0;
  data_object = digital_rf_create_write_hdf5("/tmp/hdf5/junk0", H5T_NATIVE_SHORT, 1000000, 10, global_start_sample, SAMPLE_RATE, "FAKE_UUID_0", 0, 1, 1, NUM_SUBCHANNELS, 1);
  begin = clock();
  ...
  printf("Start writing\n");
  vector_leading_edge_index=0;
  data_object = digital_rf_create_write_hdf5("/tmp/hdf5/junk0", H5T_NATIVE_SHORT, 1000000, 10, global_start_sample, SAMPLE_RATE, "FAKE_UUID_0", 1, 1, 1, NUM_SUBCHANNELS, 1);
  begin = clock();
