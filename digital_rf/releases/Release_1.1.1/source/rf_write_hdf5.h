/*******************************************************
 * rf_write_hdf5.h is the header file for the rf_write_hdf5 library
 *
 ...
 * 		into /rf_data
 *
 * $Id: rf_write_hdf5.h 383 2014-05-23 14:32:49Z brideout $
 */
...
typedef struct hdf5_write_data_object {
	...
	uint64_t   files_per_directory; 	/* number of Hdf5 files before creating a new directory */
...
} Hdf5_write_data_object;

/* Public method declarations */
Hdf5_write_data_object * digital_rf_create_write_hdf5(char * directory, hid_t dtype_id, uint64_t samples_per_file,
...
int digital_rf_write_hdf5(Hdf5_write_data_object *hdf5_data_object, uint64_t global_leading_edge_index, void * vector,
						  uint64_t vector_length);
int digital_rf_write_blocks_hdf5(Hdf5_write_data_object *hdf5_data_object, uint64_t * global_index_arr, uint64_t * data_index_arr,
...
int digital_rf_free_hdf5_data_object(Hdf5_write_data_object *hdf5_data_object);
int digital_rf_check_hdf5_directory(char * directory);
uint64_t digital_rf_write_samples_to_file(Hdf5_write_data_object *hdf5_data_object, uint64_t samples_written, uint64_t * global_index_arr,
		uint64_t * data_index_arr, uint64_t index_len, void * vector, uint64_t vector_length);
int digital_rf_create_hdf5_file(Hdf5_write_data_object *hdf5_data_object, uint64_t next_global_sample);
int digital_rf_create_new_directory(Hdf5_write_data_object *hdf5_data_object, uint64_t next_global_sample);
int digital_rf_set_fill_value(Hdf5_write_data_object *hdf5_data_object);
void digital_rf_write_metadata(Hdf5_write_data_object *hdf5_data_object);
uint64_t * digital_rf_create_rf_data_index(Hdf5_write_data_object *hdf5_data_object, uint64_t samples_written, uint64_t * global_index_arr,
			uint64_t * data_index_arr, uint64_t index_len, int * rows_to_write);
int digital_rf_write_rf_data_index(Hdf5_write_data_object * hdf5_data_object, uint64_t * rf_data_index_arr, int block_index_len);
