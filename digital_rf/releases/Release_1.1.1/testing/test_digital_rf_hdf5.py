...
$Id: test_digital_rf_hdf5.py 525 2014-08-04 18:22:16Z brideout $
"""
...
print(cont_data_arr)
# normal read
result = testReadObj.read_vector_raw(cont_data_arr[0][0], cont_data_arr[0][1], 'junk4.1')
print(len(result))
print(result)
print(result.dtype)
try:
    # read too far
    result = testReadObj.read_vector_raw(cont_data_arr[0][0], cont_data_arr[0][1]+1, 'junk4.1')
...
t = time.time()
result = testReadObj.read_vector_raw(start_index, end_index-start_index, 'junk1.2')
print('read took %f' % (time.time() - t))
print(len(result))
...
result = testReadObj.read_vector(start_index, end_index-start_index, 'junk0.11')
print('result')
print(result)
...
result = testReadObj.read_vector(start_index, end_index-start_index, 'junk3.1')
print('result')
print(result)
print('result.shape is %s' % (str(result.shape)))
print(result.dtype)
...
result = testReadObj.read_vector(start_index, end_index-start_index, 'junk1.01')
