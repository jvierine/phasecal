...
$Id: digital_rf_archive.py 701 2014-11-07 19:11:35Z brideout $
"""
...
def estimate_disk_space(startDT, endDT, source, dest, channel, is_metadata, gzip):
    """estimate_disk_space returns a tuple of (needed_GB, avail_GB) as floats
    ...
    for archive_file in archive_files:
        ...
        if ts >= startDT and ts <= endDT:
            ...
            if not is_compressed and gzip > 0 and not is_metadata:
                ...
                shutil.copy(archive_file, target_dir)
        elif ts > endDT:
            return
...
class archive:
    ...
    def _archive_channel_local_local(self, channel):
        ...
        for metadata_file in subdir_list[1]:
            ...
            shutil.copy(os.path.join(self.source, channel, metadata_file), channel_dest)
